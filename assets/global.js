...
/* harmony import */ var _test__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./test */ "./js/sections/test.js");
/* harmony import */ var _header__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./header */ "./js/sections/header.js");
//global imports here
...
document.addEventListener('DOMContentLoaded', () => {
  // getAllSpecs();
  (0,_header__WEBPACK_IMPORTED_MODULE_7__["default"])();
});
...
var headerButton = () => {
  var refreshButton = document.getElementById("refresh-header");
  refreshButton.addEventListener('click', /*#__PURE__*/(0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    var response = yield fetch("".concat(window.location.pathname, "?sections=header"));
    var data = yield response.json();
    var headerHtml = data.header;
    console.log(headerHtml);
    var currentHeader = document.getElementById("empty-div");
...
/******/ 	let __webpack_exports__ = __webpack_require__.O(undefined, ["vendors","shared"], () => (__webpack_require__("./js/sections/global.js")))
